...
export default function Footer() {
  return (
    <footer className="px-20 bg-gray-100 py-8">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="col-span-1">
          <div className="flex flex-col justify-between h-full">
            ...
            <p className="text-gray-800 mb-0">Sign up to get our special offers and news</p>
            <div className="flex">
              <input
                type="email"
                placeholder="Enter your email"
                className="rounded-full px-4 py-2 bg-transparent border-none focus:outline-none"
              />
