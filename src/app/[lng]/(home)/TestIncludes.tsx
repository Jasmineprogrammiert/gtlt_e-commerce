...
export default function TestIncludes() {
  return (
    <>
    <section className="px-10 py-16 md:p-20 text-white testIncludes">
      <div className="grid md:grid-cols-2 gap-8">
        <div className="col-span-1">
          <h2 className="text-3xl md:text-5xl mb-10 tracking-wider xl:tracking-widest">Gut Microbiome<br /> Testing Package</h2>
          <p className="mb-6">
          ...
          <h2 className="text-xl md:text-3xl mb-6 tracking-wider xl:tracking-widest">Benefit Includes:</h2>
        ...
        <div className="max-sm:hidden md:visible md:col-span-1">
          <Image
