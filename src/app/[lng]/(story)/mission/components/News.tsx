  ...
  return (
    ...
    <div className="p-20 bg-gray-50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-14">
        <Link href="/" className="bg-white shadow-lg mb-4 group max-h-[40rem]">
          <Image 
            ...
            width={200}
            height={200}
            className="w-full h-[65%] xl:h-[60%] object-cover object-center transition-transform duration-300 transform group-hover:scale-110 z-[10]" 
          />
          <div className="p-5">
